...
```json
{
  ...
  "message": "Employee created successfully",
  "employee_id": "123",
  "caller": "handlers/employee_handler.go:45"
}
```
...
```json
{
  ...
  "caller": "com.microservices.notification.controller.NotificationController"
}
```
...
_Open Zipkin at http://localhost:9411, run a query for the last 15 minutes, and sort by duration. Identify the span with the highest latency._

> **[TODO: Fill in after analysis]**
> The slowest service was: **\*\*\*\***\_\_\_\_**\*\*\*\***
> Its average response time was: **\*\*\*\***\_\_\_\_**\*\*\*\***
> It was identified by sorting traces by duration in Zipkin and inspecting the span breakdown. The cause of the delay was: **\*\*\*\***\_\_\_\_**\*\*\*\***
